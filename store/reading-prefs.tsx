...
export const ReadingPreferencesProvider: React.FC<ReadingPreferencesProviderProps> = ({ children }) => {
    ...
    const [lineHeight, setLineHeight] = usePersistentState<ReaderLineHeight>('booktown-lineheight', 'standard');
    const [margin, setMargin] = usePersistentState<ReaderMargin>('booktown-margin', 'normal');
    ...
    }), [fontSize, fontStyle, theme, readingMode, lineHeight, margin, lastPosition, setLastPositionForBook]);
