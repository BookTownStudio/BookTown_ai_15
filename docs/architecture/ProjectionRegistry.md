...
| manifestation availability projection | `authority_projection` | `manifestations` | `books.manifestationAvailability`, `editions.manifestationAvailability` | manifestation authority services, `recoverTier1PublicBetaProjection` | search results, reader entry, catalog views, discovery | Yes | Yes | Yes | Yes | Yes | `production_ready` | `production_ready` | none |
| reader authority projection | `compatibility_projection` | `manifestationAvailability` | `books.readerAuthority` | materialization, `recoverTier1PublicBetaProjection` | legacy client/search DTOs | Yes | Yes | Yes | Yes | Yes | `deprecated` | `deprecated` | compatibility-only behind `manifestation_availability_projection` |
| compatibility readability fields | `compatibility_projection` | `manifestationAvailability` | `books.downloadable`, `isEbookAvailable`, attachment pointer fields | materialization | legacy client/search DTOs | Yes | Yes | Yes | Yes | Yes | `deprecated` | `deprecated` | deprecated behind `manifestation_availability_projection` |
...
| 16 | manifestation availability projection | 3 | 3 | 5 | 3 | 3 | 17 |
