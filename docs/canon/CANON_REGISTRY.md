...
| CANON-CANDIDATE-011 | `docs/architecture/design-system/DESIGN_PHILOSOPHY.md` | candidate | candidate | Product experience doctrine | Contains durable principles for BookTown's emotional and interaction character. | Architecture design document, not Canon form. | Distill only permanent product-experience doctrine. |
| CANON-CANDIDATE-012 | `docs/architecture/design-system/BRAND_SYSTEM.md` | candidate | candidate | Brand identity principles | Contains durable master-brand and literary-platform identity principles. | Includes operational brand governance and sub-brand details. | Extract stable brand doctrine without implementation or campaign details. |
| CANON-CANDIDATE-013 | `docs/architecture/design-system/DESIGN_TOKENS.md` | candidate | candidate | Semantic design token doctrine | Defines durable separation between semantic intent and raw implementation values. | Contains implementation mapping and target-state migration content. | Extract token philosophy only, not token values or mappings. |
| CANON-CANDIDATE-014 | `docs/architecture/design-system/READER_EXPERIENCE_SYSTEM.md` | candidate | candidate | Reader experience principles | Contains long-term calm reading and attention-preservation principles. | Includes domain implementation and regression details. | Distill durable reader-experience doctrine only. |
