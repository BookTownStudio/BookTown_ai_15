...
const ProjectPublishedScreen: React.FC = () => {
    ...
    return (
        <div className="relative flex h-screen w-full flex-col items-center justify-center overflow-hidden bg-slate-900 p-6">
            ...
            <div className={`relative z-10 flex w-full max-w-2xl transform flex-col items-center transition-all duration-700 ${animate ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'}`}>
