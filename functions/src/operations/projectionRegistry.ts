...
export const PROJECTION_REGISTRY_ENTRIES: RegisteredProjectionDefinition[] = [
  ...
  defineProjection({
    projectionName: "manifestation_availability_projection",
    classification: "authority_projection",
    authoritySources: ["manifestations"],
    projectionCollections: ["books.manifestationAvailability", "editions.manifestationAvailability"],
    maintainer: "hybrid",
    currentConsumers: ["search results", "reader entry", "catalog views", "discovery"],
    currentCertificationStatus: "production_ready",
    rebuildSupported: true,
    verificationSupported: true,
    reconciliationSupported: true,
    ...
    idempotent: true,
    restartable: true,
    requiredIndexes: ["books(__name__)", "editions(__name__)", "manifestations(editionId,status)"],
    runbookPath: `${RUNBOOK_ROOT}/ReaderAuthorityProjectionRecoveryRunbook.md`,
    recoveryGaps: [],
    notes: "Certified WEM readability and availability projection. Manifestation authority owns access, rendering, acquisition eligibility, and readable availability.",
  }),
  defineProjection({
    projectionName: "reader_authority_projection",
    classification: "compatibility_projection",
    authoritySources: ["manifestationAvailability"],
    projectionCollections: ["books.readerAuthority"],
    maintainer: "hybrid",
    currentConsumers: ["legacy client", "legacy search DTOs"],
    currentCertificationStatus: "deprecated",
    requiredCertificationStatus: "deprecated",
    rebuildSupported: true,
    verificationSupported: true,
    ...
    runbookPath: `${RUNBOOK_ROOT}/ReaderAuthorityProjectionRecoveryRunbook.md`,
    recoveryGaps: [],
    notes: "Compatibility-only projection. readerAuthority must not be used as readability authority; use manifestationAvailability.",
  }),
  defineProjection({
    ...
    recoveryGaps: [],
    notes: "Deprecated behind certified manifestation_availability_projection; maintained only for legacy compatibility until removal.",
  }),
  defineProjection({
